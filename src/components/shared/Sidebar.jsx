...
function Sidebar(props) {
  ...
  return (
    <div className={`bg-primary fixed lg:left-0 top-0 w-28 h-full flex flex-col justify-between py-6 rounded-tr-xl rounded-br-xl z-50 transition-all ${showMenu ? "left-0" : "-left-full"}`}>
        <ul className="pl-4">
